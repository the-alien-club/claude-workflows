...
0c. use Notion to track the ticket - ./ai-memories/tech/tickets/ENG-xxxx.md
...
2. when the plan is complete, `Update Notion task` and attach the doc to the ticket using the MCP tools and create a terse comment with a link to it (re-read .claude/commands/linear.md if needed)
...
Created at ai-memories/tech/platform/[feature-name]/plan/implementation-plan.md
Synced to Notion
