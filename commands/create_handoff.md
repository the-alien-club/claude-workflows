...
Use the following information to understand how to create your document:
    - create your file under `ai-memories/tech/handoffs/ENG-XXXX/YYYY-MM-DD_HH-MM-SS_ENG-ZZZZ_description.md`, where:
...
```bash
/resume_handoff ai-memories/tech/handoffs/ENG-2166/2025-01-08_13-44-55_ENG-2166_create-context-compaction.md
```
</example_response>
