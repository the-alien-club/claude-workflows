...
- The ai-memories/tech/ directory is local to the main repo and worktrees
- Always use ONLY the relative path starting with `ai-memories/tech/...` without any directory prefix
- Example: `ai-memories/tech/platform/fix-mcp-keepalive-proper.md` (not the full absolute path)
- This works because ai-memories/tech/ is repository-specific
