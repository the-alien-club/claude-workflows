...
- **ai-memories context** if `ai-memories/tech/platform/[feature-name]/` exists — read `plan/implementation-plan.md` and `implement/implementation-log.md`
...
mcp__claude_ai_Atlassian__createJiraIssue
  ...
  assignee: "712020:2c2be07a-0644-49bc-b811-f97ebf5119b6"
```
