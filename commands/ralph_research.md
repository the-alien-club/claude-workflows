...
2g. document findings in ai-memories/tech: `ai-memories/tech/platform/[feature-name]/plan/implementation-plan.md`
...
3d. run `Update Notion task` to save the research
