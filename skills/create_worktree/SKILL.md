...
- The ai_docs/ directory is local to the main repo and worktrees
- Always use ONLY the relative path starting with `ai_docs/...` without any directory prefix
- Example: `ai_docs/fix-mcp-keepalive-proper.md` (not the full absolute path)
- This works because ai_docs/ is repository-specific
